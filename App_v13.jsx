...
const THEMES = {
  ...
  midnight: {
    id:"midnight", name:"Midnight & Silver",
    C:{ id:"midnight", bgPrimary:"#0D0B14", bgSecondary:"#13101E", bgCard:"#1A1628",
        textPrimary:"#E4E0F0", textSoft:"#A89EC0", textMuted:"#6A607A",
        sage:"#7A6E9A", sageDark:"#5A5078", sageLight:"#9A8EBA",
        amber:"#C0B0D8", amberLight:"#D8CFF0", terra:"#8A7AAA",
        accent:"#9A88C0", accentAlt:"#7A6E9A", border:"#221E32", navBg:"#0A0810" },
  },
  crimson: {
    id:"crimson", name:"Crimson & Iron",
    C:{ id:"crimson", bgPrimary:"#0E0A0A", bgSecondary:"#180F0F", bgCard:"#221414",
        textPrimary:"#EDE0D8", textSoft:"#C0A898", textMuted:"#7A6058",
        sage:"#8A7060", sageDark:"#6A5040", sageLight:"#AA9080",
        amber:"#C04040", amberLight:"#D86060", terra:"#A03030",
        accent:"#B83838", accentAlt:"#8A4040", border:"#2C1818", navBg:"#0A0808" },
  },
};

// Themes available in settings (exclude neutral — it's only for pre-onboarding)
const CUSTOMIZABLE_THEMES = ["warm","masculine","navy","forest","charcoal","slate","obsidian","midnight","crimson"];
...
function ReflectScreen({ C, font, setScreen, faithLevel, sessionCount, tone, onSessionComplete, onboardingAnswers, userName, isMinorUser, tier, sessionHistory, seasonalContext }) {
...
function SettingsScreen({ C, font, setScreen, theme, setTheme, fontId, setFontId,
  ...
  seasonalMode, setSeasonalMode, currentSeason }) {
                    ...
                    <div style={{ flex:1 }}>
                      ...
                      <p style={{ color:C.textMuted,fontSize:"10px",fontStyle:"italic",margin:0 }}>
                        {id==="warm"?"Soft & grounded · warm sanctuary":
                         ...
                         id==="midnight"?"Dark & spiritual · midnight clarity":
                         id==="crimson"?"Bold & intense · crimson & iron":
...
useEffect(() => {
  ...
  useEffect(() => {
    saveToStorage({
      ...
      lastActiveDate, bestStreak, totalActiveDays, graceUsedWeek, sessionHistory, assessmentResults, userEmail, stripeEmail, seasonalMode,
    });
