...
const CUSTOMIZABLE_THEMES = ["warm","masculine","navy","forest","charcoal","slate"];
...
function Label({ text, color, font }) {
  return (
    <div style={{ display:"flex",alignItems:"center",gap:"6px",marginBottom:"12px" }}>
      <Dot color={color}/>
      <span style={{ color,fontSize:"10px",letterSpacing:"3px",textTransform:"uppercase",fontStyle:"italic",fontFamily:font }}>
        {text}
      </span>
    </div>
  );
        ...
        {sessionActive && phase !== "done" && (
          <>
            ...
            <button onClick={reset} style={{ background:"none", border:`1px solid ${C.border}`,
              ...
              fontFamily:font, fontStyle:"italic" }}>End Early</button>
          </>
        )}
  ...
  const steps = [
    {
      ...
      body: "Let me show you around. This will take 30 seconds and help you get the most out of Selah. You can skip anytime.",
      preview: (
    ...
    },
    {
      ...
      body: "Tap Reflect to start a guided AI conversation. Pick a topic or write freely. Selah listens, asks questions, and helps you think clearly. Sessions are 5–10 minutes.",
      preview: (
        <div style={{ display:"flex", flexDirection:"column", gap:"6px", margin:"16px 0" }}>
          {[{icon:"🌊",label:"Stress"},{icon:"🧭",label:"Direction"},{icon:"🪞",label:"Identity"},
            {icon:"✦",label:"Faith"},{icon:"🤝",label:"Relationships"},{icon:"⚡",label:"Discipline"}].map(c=>(
            <div key={c.label} style={{ display:"inline-flex", alignItems:"center", gap:"6px",
              background:C.bgSecondary, borderRadius:"8px", padding:"6px 12px", marginRight:"6px" }}>
              <span style={{ fontSize:"12px" }}>{c.icon}</span>
              <span style={{ color:C.textSoft, fontSize:"10px", fontStyle:"italic" }}>{c.label}</span>
            </div>
          ))}
        </div>
      ),
    ...
    },
    {
      ...
      body: "Don't have time for a full session? The Quick Check-in lets you log your mood, set an intention, and get a personal reflection in under 2 minutes.",
      preview: (
        <div style={{ display:"flex", gap:"10px", justifyContent:"center", margin:"16px 0" }}>
          {["😔","😕","😐","🙂","😌"].map((e,i)=>(
            <div key={i} style={{ width:"36px", height:"36px", borderRadius:"50%",
              background:i===3?`${C.accent}22`:C.bgSecondary,
              border:`1.5px solid ${i===3?C.accent:"transparent"}`,
              display:"flex", alignItems:"center", justifyContent:"center",
              fontSize:"16px" }}>{e}</div>
          ))}
        </div>
    ...
    {
      icon: "🫁",
      title: "Breathe — calm your nervous system.",
      body: "Three guided breathing techniques used by therapists and the military. Box Breathing, 4-7-8, and Physiological Sigh. Use before a session or whenever you need to reset.",
      preview: (
    ...
    },
    {
      ...
      body: "No prompts required. No one reads it but you. Write whatever is on your heart. Your notebook entries are stored locally on your device.",
      preview: null,
    },
    {
      icon: "📊",
      title: "Track your growth.",
      body: "Your Progress page shows mood patterns, streaks, session history, and milestones. The Growth Mirror (Growth plan and above) uses AI to show you how you've changed over time.",
      preview: (
        <div style={{ display:"flex", gap:"8px", justifyContent:"center", margin:"16px 0" }}>
          {[{label:"Streak",val:"🔥"},{label:"Mood",val:"📈"},{label:"Sessions",val:"💬"}].map(s=>(
            <div key={s.label} style={{ background:C.bgSecondary, borderRadius:"8px",
              padding:"12px 16px", textAlign:"center" }}>
              <span style={{ fontSize:"18px" }}>{s.val}</span>
    ...
    },
    {
      ...
      body: "Take self-assessments for personality type, left/right brain, ADHD screening, anxiety levels, and trauma response. Available with Foundation plan and above. These aren't diagnoses — they're mirrors.",
      preview: null,
    },
    {
      icon: "🎨",
      title: "Make it yours.",
      body: "Customize colors, fonts, AI tone, and faith level in Settings. Selah adapts to you — not the other way around. You can change any of this anytime.",
      preview: (
        <div style={{ display:"flex", gap:"6px", justifyContent:"center", margin:"16px 0" }}>
          {[
            ...
            { label:"Forest", colors:["#F8F4EC","#3D6B4F","#C4A96A","#9A6848"] },
          ].map(t => (
    ...
    },
    {
      ...
      body: "The heart icon in the top-right corner is always accessible. It connects you to 988 Suicide & Crisis Lifeline, Crisis Text Line, STOMP Out Bullying HelpChat (ages 13-24), and emergency services. You are never alone.",
      preview: (
        <div style={{ display:"flex", justifyContent:"center", margin:"16px 0" }}>
    ...
    {
      icon: "📱",
      title: "Add Selah to your phone.",
      body: "Want Selah on your home screen like a real app? No app store needed — it works right from your browser.",
      preview: (
        <div style={{ display:"flex", flexDirection:"column", gap:"10px", margin:"16px 0" }}>
          <div style={{ background:C.bgSecondary, borderRadius:"10px", padding:"14px 16px",
            border:`1px solid ${C.border}` }}>
            <p style={{ color:C.textPrimary, fontSize:"11px", fontWeight:"bold",
              fontFamily:font, margin:"0 0 6px" }}>iPhone / iPad (Safari)</p>
            <p style={{ color:C.textSoft, fontSize:"11px", fontStyle:"italic",
              lineHeight:"1.7", margin:0 }}>
              Tap the <strong>Share</strong> button (square with arrow) → scroll down → tap <strong>"Add to Home Screen"</strong>
            </p>
          </div>
          <div style={{ background:C.bgSecondary, borderRadius:"10px", padding:"14px 16px",
            border:`1px solid ${C.border}` }}>
            <p style={{ color:C.textPrimary, fontSize:"11px", fontWeight:"bold",
              fontFamily:font, margin:"0 0 6px" }}>Android (Chrome)</p>
            <p style={{ color:C.textSoft, fontSize:"11px", fontStyle:"italic",
              lineHeight:"1.7", margin:0 }}>
              Tap the <strong>⋮ menu</strong> (three dots) → tap <strong>"Add to Home Screen"</strong> or <strong>"Install App"</strong>
            </p>
          </div>
        </div>
      ),
    },
    {
      ...
      body: "Your journal entries, streaks, mood history, and assessments are precious. Sign in with your email in Settings to back everything up to the cloud. If you ever switch phones or clear your browser, your data is safe.",
      preview: (
        <div style={{ background:C.bgSecondary, borderRadius:"10px", padding:"16px",
          margin:"16px 0", border:`1px solid ${C.border}` }}>
          <div style={{ display:"flex", alignItems:"center", gap:"12px", marginBottom:"12px" }}>
            ...
            <div>
              <p style={{ color:C.textPrimary, fontSize:"12px", fontFamily:font,
                margin:"0 0 2px" }}>you@email.com</p>
          ...
          <p style={{ color:C.textMuted, fontSize:"10px", fontStyle:"italic", margin:0 }}>
            Settings → Back Up Your Data → Sign In with Email
          </p>
        </div>
      ),
      action: { label:"Open Settings", fn:()=>{onDismiss();onGoToSettings();} },
    ...
    {
      icon: "🧭",
      title: "Navigate with the bottom bar.",
      body: "Home is your hub. Reflect, Notebook, Progress, and Settings are always one tap away at the bottom of the screen. You're ready.",
      preview: (
...
// HOME SCREEN
// ═══════════════════════════════════════════════════════
function HomeScreen({ C, font, setScreen, userName, steadyDays, showLateNight, sharingEnabled, onboardingAnswers, faithLevel, isFirstVisit, onDismissWelcome, onLogMood, onActive, lastFeedbackPrompt, onDismissFeedback, sessionCount, tone, quoteFreq, tier, isTrialActive, onUpgrade, moodHistory, sessionHistory, journalEntries }) {
  ...
  const [ttlmDismissed,setTtlmDismissed]=useState(()=>{ try{ const d=localStorage.getItem("selah_ttlm_dismissed"); return d===new Date().toDateString(); }catch{return false;} });
...
Write in second person ("you"). No bullet points. No therapy-speak. Sound like a wise friend, not an app.`}]
  ...
  // Daily AI Encouragement — Growth+ only, cached per day
  useEffect(() => {
  ...
  const isAdmin = new URLSearchParams(window.location.search).get("admin") === "f7a3d9e2-4c1b-4e8f-b2a6-9d5c3e7f1a04";
  const canShowAnchor = isAdmin || (TIER_LEVELS[tier]||0) >= TIER_LEVELS.foundation;

  const isAnchorExpired = (cached) => {
    if (!cached || !cached.timestamp) return true;
    const now = new Date();
    const cachedTime = new Date(cached.timestamp);
    const freq = quoteFreq || "daily";
    if (freq === "hourly") {
    ...
    try {
      const r=await fetch("/api/chat",{
        ...
        body:JSON.stringify({ model:"claude-sonnet-4-20250514",max_tokens:600,
          messages:[{role:"user",content:`Generate a daily anchor for someone working on mental clarity and inner growth.${userContext?` Context about them: ${userContext}.`:""} ${faithLevel>=2?"Include faith-based quotes.":"Lean secular — philosophers, psychologists, wisdom traditions."}${avoidText} Variety seed: ${seed}. Return ONLY JSON with no markdown:
{"quote":"a meaningful quote (Bible verse, philosopher, psychiatrist, or faith leader)","author":"source or name","type":"Bible|Wisdom|Faith|Philosophy","theme":"the core theme","question":"one grounding reflection question tied to the quote — direct, not therapy-speak. Under 20 words.","action":"one small, concrete action they can take today. Under 20 words. Starts with a verb."}`}] }) });
  ...
  // ── Notifications: load daily inspiration + changelog ──
  const CHANGELOG = [
    { id:"v1.5", date:"Feb 24, 2026", title:"Guided Tour Added", body:"New users now get an optional walkthrough showing every feature. Settings → Reset to replay it.", type:"update" },
    { id:"v1.4", date:"Feb 24, 2026", title:"Subscription Tiers Live", body:"Foundation, Growth, and Deep Reflection plans are now available with Stripe checkout.", type:"update" },
    { id:"v1.3", date:"Feb 24, 2026", title:"Notebook Renamed", body:"Journal is now called Notebook — same private space, fresh name.", type:"update" },
  ];
  ...
  useEffect(()=>{
    const loadNotifications = async () => {
      ...
      // Add changelog items
      CHANGELOG.forEach(c => {
        items.push({ ...c, read: readIds.includes(c.id) });
      });
    ...
    <div style={{ minHeight:"100vh",background:C.bgPrimary,fontFamily:font,
        ...
        <div style={{ display:"flex",justifyContent:"space-between",
          ...
          <div>
            ...
            <h1 style={{ color:C.textPrimary,fontSize:"18px",fontWeight:"normal",
              ...
              {userName?`Good to see you, ${userName}.`:"Selah"}
            </h1>
          </div>
          <div style={{ display:"flex",gap:"8px",alignItems:"center" }}>
            {/* Feedback */}
            ...
            <div onClick={()=>setScreen("progress")}
              style={{ background:C.bgSecondary,borderRadius:"8px",
                padding:"8px 14px",border:`1px solid ${C.amber}33`,
                display:"flex",alignItems:"center",gap:"6px",cursor:"pointer" }}>
              <span style={{ fontSize:"14px" }}>🔥</span>
              <span style={{ color:C.amber,fontSize:"15px",fontWeight:"bold",fontFamily:font }}>{steadyDays}</span>
            </div>
          </div>
        </div>
      ...
      {dailyEncouragement && (TIER_LEVELS[tier]||0) >= TIER_LEVELS.growth && (
        ...
        {(()=>{
          ...
          if ((TIER_LEVELS[tier]||0) < TIER_LEVELS.foundation) return null;
          const now = Date.now();
          const moodEntry = (moodHistory||[]).find(m => {
            const age = (now - new Date(m.date).getTime()) / (1000*60*60*24);
            return age >= 25 && age <= 35;
          });
          const sessionEntry = (sessionHistory||[]).find(s => {
            const age = (now - new Date(s.date).getTime()) / (1000*60*60*24);
            return age >= 25 && age <= 35;
          });
          ...
          const dismiss = () => { try{localStorage.setItem("selah_ttlm_dismissed", new Date().toDateString());}catch{} setTtlmDismissed(true); };
          return (
            <div style={{ background:`${C.terra}08`, border:`1px solid ${C.terra}33`,
              ...
              <p style={{ color:C.terra, fontSize:"9px", letterSpacing:"2.5px",
                textTransform:"uppercase", fontStyle:"italic", margin:"0 0 8px" }}>This time last month</p>
              {moodLabel && (
              ...
              {[
                ...
                <button key={item.label} onClick={item.action} style={{
                  ...
                  <div style={{ flex:1 }}>
                    ...
                    <p style={{ color:C.textMuted, fontSize:"10px", fontStyle:"italic", margin:0 }}>{item.sub}</p>
                  </div>
        ...
        <div style={{ display:"grid",gridTemplateColumns:"1fr 1fr",gap:"10px",marginBottom:"24px" }}>
          {[
            ...
            {icon:"✦",label:"Reset",sub:(TIER_LEVELS[tier]||0)<TIER_LEVELS.foundation?"🔒 Foundation+":"Decompress",bg:`${C.sage}08`,color:C.sage,border:`${C.sage}15`,screen:"bestill"},
            ...
            {icon:"🌑",label:"Heavy Day",sub:(TIER_LEVELS[tier]||0)<TIER_LEVELS.foundation?"🔒 Foundation+":"Lament. Be honest.",bg:`${C.terra}08`,color:C.terra,border:`${C.terra}18`,screen:"heavyday"},
            {icon:"🤍",label:"Crisis Help",sub:"You're not alone",bg:`${C.terra}10`,color:C.terra,border:`${C.terra}18`,screen:"_crisis"},
          ].map(item=>(
            <button key={item.label} onClick={()=>item.screen==="_crisis"?setShowCrisisPanel(true):setScreen(item.screen)} style={{
            ...
            onMouseLeave={e=>e.currentTarget.style.transform="translateY(0)"}>
              ...
              <span style={{ color:C.textSoft,fontSize:"10px",fontStyle:"italic" }}>{item.sub}</span>
            </button>
          ))}
        </div>
        ...
        <div style={{ background:C.bgSecondary,borderRadius:"10px",
          padding:"18px 20px",border:`1px solid ${C.terra}22` }}>
          <div style={{ display:"flex",justifyContent:"space-between",
            alignItems:"center",marginBottom:"4px" }}>
            <Label text="Daily Pulse" color={C.amber} font={font}/>
            {mood!==null&&pulseEnergy!==null&&(
              <span style={{ color:C.sage,fontSize:"9px",letterSpacing:"2px",
                textTransform:"uppercase",fontStyle:"italic" }}>✓ Logged</span>
            )}
          </div>
          <p style={{ color:C.textMuted,fontSize:"11px",fontStyle:"italic",margin:"0 0 10px" }}>
            How are you feeling?
          </p>
          <div style={{ display:"flex",gap:"8px",justifyContent:"space-between",marginBottom:"14px" }}>
            {["😔","😕","😐","🙂","😌"].map((e,i)=>(
              <button key={i} onClick={()=>setMood(i)} style={{
                background:mood===i?`${C.terra}22`:C.bgPrimary,
                border:`1.5px solid ${mood===i?C.terra:"transparent"}`,
                borderRadius:"50%",width:"44px",height:"44px",fontSize:"19px",
                cursor:"pointer",transition:"all 0.2s ease",
                display:"flex",alignItems:"center",justifyContent:"center" }}
          ...
          <p style={{ color:C.textMuted,fontSize:"11px",fontStyle:"italic",margin:"0 0 8px" }}>
            Energy level?
          </p>
          <div style={{ display:"flex",gap:"6px",marginBottom:"14px" }}>
            {["Low","Medium","High"].map((lv,i)=>(
              <button key={lv} onClick={()=>setPulseEnergy(i)} style={{
                flex:1,background:pulseEnergy===i?`${C.sage}22`:C.bgPrimary,
                border:`1.5px solid ${pulseEnergy===i?C.sage:"transparent"}`,
                borderRadius:"6px",padding:"8px 4px",cursor:"pointer",
                color:pulseEnergy===i?C.sage:C.textMuted,
                fontSize:"11px",fontStyle:"italic",fontFamily:font,
                transition:"all 0.2s ease" }}>{lv}</button>
            ))}
          </div>
          <p style={{ color:C.textMuted,fontSize:"11px",fontStyle:"italic",margin:"0 0 8px" }}>
            One word for today?
          </p>
          <input value={pulseWord} onChange={e=>setPulseWord(e.target.value)}
            placeholder="Anxious · Hopeful · Tired · Ready..."
            style={{ width:"100%",boxSizing:"border-box",background:C.bgPrimary,
              border:`1.5px solid ${pulseWord?C.sage+"55":C.border}`,
              borderRadius:"6px",padding:"10px 14px",color:C.textPrimary,
              fontSize:"13px",fontStyle:"italic",fontFamily:font,outline:"none",
    ...
    <div style={{ ...containerStyle, justifyContent:"flex-start", paddingTop:"80px" }}>
      <div style={{ width:"100%", maxWidth:"460px" }}>
        ...
        <div style={{ display:"flex", justifyContent:"space-between",
          ...
          <button onClick={()=>setPhase("breathe")} style={{
            background:"none",border:"none",cursor:"pointer",
            color:C.textMuted,fontSize:"12px",fontStyle:"italic" }}>← Back</button>
...
function ReflectScreen({ C, font, setScreen, faithLevel, sessionCount, tone, onSessionComplete, onboardingAnswers, userName, isMinorUser, tier, sessionHistory }) {
      ...
      <div style={{ maxWidth:"400px",width:"100%" }}>
        ...
        <div style={{ display:"flex",gap:"10px" }}>
          <button onClick={()=>setScreen("home")} style={{ flex:1,background:C.bgSecondary,
            ...
            cursor:"pointer",fontFamily:font,fontStyle:"italic" }}>Home</button>
          <button onClick={reset} style={{ flex:2,background:C.accent,border:"none",
            borderRadius:"3px",color:"#fff",fontSize:"10px",letterSpacing:"3px",
            textTransform:"uppercase",padding:"14px",cursor:"pointer",
            fontFamily:font,fontStyle:"italic" }}>Reflect Again</button>
        </div>
      </div>
    </div>
  );
...
// ═══════════════════════════════════════════════════════
function ResourcesScreen({ C, font, setScreen, onboardingAnswers, faithLevel }) {
  ...
  // Auto-load personalized recommendations from onboarding
  useEffect(()=>{
    ...
    try {
      const r=await fetch("/api/chat",{
        ...
        body:JSON.stringify({model:"claude-sonnet-4-20250514",max_tokens:800,
          messages:[{role:"user",content:`Generate 3 personalized book/resource recommendations for someone with this profile: ${context}. ${faithLevel>=2?"Include at least one faith-based resource.":"Lean secular."} Return ONLY a JSON array: [{"title":"...","author":"...","description":"2 sentences why this is perfect for them right now.","whyNow":"one personal sentence connecting to their situation","type":"book|podcast|practice"}] No markdown.`}]})});
      const d=await r.json();
      if(d.error) throw new Error(d.error?.message||"API error");
      const t=d.content.map(b=>b.text||"").join("").trim();
      const parsed=JSON.parse(t.replace(/```json|```/g,"").trim());
  ...
  return (
    <div style={{ minHeight:"100vh",background:C.bgPrimary,fontFamily:font,
      ...
      <div style={{ maxWidth:"480px",margin:"0 auto" }}>
        ...
        {/* Auto-generated personal recommendations */}
        {(autoRecs||autoLoading)&&(
          <div style={{ marginBottom:"24px" }}>
              ...
              <div key={i} style={{ background:`${r.color}10`, borderRadius:"10px",
                ...
                <div style={{ display:"flex", alignItems:"center", gap:"6px", marginBottom:"6px" }}>
                  ...
                  <span style={{ color:r.color, fontSize:"8px", letterSpacing:"2px",
                    ...
                    {r.type === "podcast" ? "🎙 Podcast" : r.type === "practice" ? "🧘 Practice" : "📖 Book"} · Based on your profile
                  </span>
                </div>
                <p style={{ color:C.textPrimary, fontSize:"14px", fontWeight:"bold",
        ...
        <div style={{ background:`${C.accent}15`,border:`1px solid ${C.accent}33`,
          ...
          <div style={{ display:"flex",gap:"8px" }}>
            <input value={aiQuery} onChange={e=>setAiQuery(e.target.value)}
              ...
              style={{ flex:1,background:C.bgPrimary,border:`1px solid ${C.border}`,
                borderRadius:"6px",padding:"10px 14px",color:C.textPrimary,
                fontSize:"13px",fontStyle:"italic",fontFamily:font,outline:"none" }}/>
            <button onClick={getAIRecs} disabled={!aiQuery.trim()||loading} style={{
              background:aiQuery.trim()&&!loading?C.accent:C.bgCard,border:"none",
              borderRadius:"6px",padding:"10px 16px",cursor:aiQuery.trim()&&!loading?"pointer":"default",
              color:aiQuery.trim()&&!loading?"#fff":C.textMuted,fontSize:"11px",
          ...
          {recs&&recs.map((r,i)=>(
            <div key={i} style={{ background:C.bgSecondary,borderRadius:"8px",
              padding:"14px",marginTop:"10px",border:`1px solid ${r.color}33` }}>
              <p style={{ color:r.color,fontSize:"10px",letterSpacing:"2px",
                textTransform:"uppercase",fontStyle:"italic",margin:"0 0 4px" }}>Recommended</p>
              <p style={{ color:C.textPrimary,fontSize:"14px",fontWeight:"bold",
                fontFamily:font,margin:"0 0 2px" }}>{r.title}</p>
              <p style={{ color:r.color,fontSize:"11px",fontStyle:"italic",margin:"0 0 8px" }}>{r.author}</p>
              <p style={{ color:C.textSoft,fontSize:"12px",fontStyle:"italic",
        ...
        {BOOKS.map((b,i)=>(
          <div key={i} style={{ background:C.bgSecondary,borderRadius:"10px",
            padding:"18px",marginBottom:"10px",border:`1px solid ${b.color}22` }}>
            <div style={{ display:"flex",justifyContent:"space-between",
              alignItems:"flex-start",marginBottom:"8px" }}>
              <div style={{ flex:1 }}>
                <p style={{ color:b.color,fontSize:"9px",letterSpacing:"2px",
                  textTransform:"uppercase",fontStyle:"italic",margin:"0 0 4px" }}>📖 Book</p>
                <p style={{ color:C.textPrimary,fontSize:"15px",fontWeight:"bold",
                  fontFamily:font,margin:"0 0 2px" }}>{b.title}</p>
                <p style={{ color:b.color,fontSize:"11px",fontStyle:"italic",margin:0 }}>{b.author}</p>
              </div>
            </div>
            <p style={{ color:C.textSoft,fontSize:"12px",fontStyle:"italic",
                  ...
                  <div>
                    ...
                    <div style={{ display:"flex", gap:"8px" }}>
                      <button onClick={()=>{setLoginStep("email");setLoginCode("");setLoginError("");}} style={{
                        ...
                        borderRadius:"3px", color:C.textMuted, fontSize:"10px", letterSpacing:"2px",
                        textTransform:"uppercase", padding:"12px", cursor:"pointer",
                        fontFamily:font, fontStyle:"italic" }}>Back</button>
                      <button onClick={async()=>{
...
function SubscriptionScreen({ C, font, onBack, currentTier, onSelectTier, trialDaysLeft, userEmail, onStripeEmail, onAutoLogin }) {
  ...
  const TIERS=[
    ...
    {id:"foundation",name:"Foundation",
      ...
      features:["Unlimited AI reflections","Daily or weekly anchor refresh","Quick check-in (2-min mode)","Self-discovery assessments","Full session history & streaks","All themes, fonts & customization"],
      locked:[]},
    ...
    {id:"deep",name:"Deep Reflection",
      ...
      features:["Everything in Growth","Hourly anchor refresh","Know Yourself — 100-question AI personality assessment","Pattern detection across sessions","\"This Time Last Month\" insights","Guided challenges (7, 14, 30-day)","Exclusive AI tones (Mentor, Coach)","Custom reflection categories","Extended conversation memory","Priority responses & early access"],
      locked:[]},
  ];
...
useEffect(() => {
  ...
  const markActive = () => {
    ...
    if (lastActiveDate === yesterdayStr) {
      ...
      // Streak broken (or first ever) — start at 1
      setSteadyDays(1);
  ...
  // Check streak on app load — if they missed yesterday, reset
  useEffect(() => {
    if (!lastActiveDate || appScreen !== "main") return;
    const yesterday = new Date();
    yesterday.setDate(yesterday.getDate() - 1);
    const yesterdayStr = getDateStr(yesterday);
    // If last active date is before yesterday and not today, streak is broken
  ...
  useEffect(() => {
    saveToStorage({
      ...
      lastActiveDate, bestStreak, totalActiveDays, sessionHistory, assessmentResults, userEmail, stripeEmail,
    });
  ...
  const renderMain = () => {
    ...
    switch(screen) {
      case "home": return (
        <HomeScreen C={C} font={font} setScreen={setScreen}
          ...
          isFirstVisit={isFirstVisit} onDismissWelcome={()=>setIsFirstVisit(false)}
          ...
          moodHistory={moodHistory} sessionHistory={sessionHistory} journalEntries={journalEntries}/>
      );
      case "reflect": {
        ...
        return (
          <ReflectScreen C={C} font={font} setScreen={setScreen}
      ...
      case "heavyday": {
        if ((TIER_LEVELS[effectiveTier]||0) < TIER_LEVELS.foundation) {
          return (
            <div style={{ minHeight:"100vh", background:C.bgPrimary, fontFamily:font, padding:"60px 20px", boxSizing:"border-box" }}>
              <div style={{ maxWidth:"480px", margin:"0 auto" }}>
                ...
                <UpgradeGate C={C} font={font} feature="Heavy Day / Lament" requiredTier="foundation" onUpgrade={()=>setShowSub(true)}/>
              </div>
            </div>
          );
        }
      ...
      case "settings": return (
        <SettingsScreen C={C} font={font} setScreen={setScreen}
      ...
      case "resources": {
        ...
        return <ResourcesScreen C={C} font={font} setScreen={setScreen} onboardingAnswers={onboardingAnswers} faithLevel={faithLevel}/>;
      }
      case "stories": {
  ...
  return (
    <div style={{ fontFamily:font,background:C.bgPrimary,minHeight:"100vh",
      ...
      {!showSub&&screen!=="breathe"&&screen!=="checkin"&&screen!=="bestill"&&(
